...
class PdsXv13:
    def _get_size(self, type_name):
        ...
        if type_name in self.type_table:
            if type_name == "STRING":
                return 256  # Varsayılan string boyutu
                ...
                if type_def["kind"] == "STRUCT":
                    ...
                    return 4  # Enum varsayılan olarak 4 bayt
            elif type_name == "VOID":
                return 0
            return 8  # Varsayılan boyut
...
# PdsXv13 sınıfının geri kalanı burada devam eder, ancak _get_size'den sonrası istendiği için burada tamamlanıyor.
# --------------------------------------------------
#---------------------------------------------------
